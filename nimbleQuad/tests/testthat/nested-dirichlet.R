...
result$improveParamMarginals(1:3, nMarginalGrid = 7) ## Pretty good.
...
## AGHQ
approx2 <- buildNestedApprox(m, latentNodes = c('beta_int','beta_treat','beta_period','beta_carry'), paramNodes = c('psi'), control = list(paramGridRule='AGHQ',nQuadOuter=5))
...
result$improveParamMarginals('psi', nMarginalGrid = 7)
