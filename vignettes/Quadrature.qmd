...
[NIMBLE](https://r-nimble.org](https://r-nimble.org) is a system for writing hierarchical statistical models and algorithms.  It is distributed as an R package [nimble](https://CRAN.R-project.org/package=nimble). NIMBLE includes:
...
The nested approximation and INLA results match MCMC well, though for some reason the densities plotted by INLA doesn't quite integrate to one and therefore lies above the other two lines.
